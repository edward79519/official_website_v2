            ...
            <div class="container text-center px-4 px-lg-5 h-100">  
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">關於寶晶</h1>
                        <hr class="divider" />
                    </div>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="mt-0">寶晶能源</h2>
                        <hr class="divider" />
                        <p class="mb-4">寶晶能源股份有限公司在2018年時由董事長蔡佳晋先生帶著滿懷對抗氣候變遷的熱情一手創立，以保護地球、永續家園、節能減碳、潔淨能源為己任。為寶佳集團之關係企業，主要股東包含國泰永續能源基金與遠雄人壽。</p>
                        <p class="mb-4">寶晶能源致力於提供企業一站式能源解決方案，以創能、節能、儲能與售電為四大業務主軸。</p>
                        <p class="mb-4">寶晶能源在蔡佳晋董事長領軍下，結合各方專業力量—電力、模組、開發、設計、財務與法務，期望在對抗全球暖化盡最大的努力。</p>
                    </div>
                </div>
            </div>
        </section>
                            ...
                            <div class="row g-0">
                                ...
                                <div class="col-md-8 align-items-center d-flex align-items-stretch justify-content-center">
                                    <div class="card-body px-4 pb-5">
                                        <h3 class="card-title mt-3">蔡佳晋</h5>
                                        <h4 class="card-title">董事長</h4>
                                        <p class="card-text mt-5">
                                        曾任職國際票券董事總經理、台灣票券董事、中華民國銀行公會監事、中華民國票券金融同業公會理事、中華民國證券同業公會理事、台北市商業公會會員、台北市嘉義高中校友會理事等。另曾任上市櫃公司台紙董事、聯茂電子獨立董事、京城銀行獨立董事，金融資歷豐富。
                                        </p>
                                    </div>
                                </div>
                            </div>
